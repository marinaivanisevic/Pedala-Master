...
<title>Pedala | Moje Iskustvo </title>
<!--Bootstrap -->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Moje iskustvo</h5>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Active</a>
                  ...
                  <?php } else {?>
               <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Čeka se odobrenje!</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
