...
<title>Pedala| Lista biciklova</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Pronađi svoj bicikl </h5>
          </div>
          <div class="sidebar_filter">
            <form action="search-carresult.php" method="post">
              <div class="form-group select">
                <select class="form-control" name="brand">
                  <option>Selektuj bicikl</option>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="fueltype">
                  <option>Selektuj opremu</option>
<option value="Kaciga">Kaciga</option>
<option value="Naočare">Naočare</option>
<option value="Sedište">Dečije sedište</option>
                </select>
              </div>

              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i>Pretraži</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-bicycle" aria-hidden="true"></i> Nedavno pregledani bicikli</h5>
          </div>
