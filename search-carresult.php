...
{  ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
		...
		<option value="Dečije sedište">Dečije sedište</option>
								</select>
							</div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Nedavno pregledano</h5>
          </div>
