...
<title>Pedala - Rent a bike</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-11 col-md-push-1">
          <div class="banner_content">
            <h1>Pronađi svoj savršeni bicikl</h1>
            <p>Mi imamo najbolji izbor </p>
            <a href="index.php" class="btn">Pročitaj više <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Pronađi svoj  <span>savršeni bicikl</span></h2>
      <p>Kod nas možete iznajmiti bicikle na sat, dan, nedelju ili na duži vremenski period. Naša specijalnost su rent a bike ture za grupe ino turista gde se za obilazak grada Novog Sada iznajmljuje u jednoj turi preko 30 bicikala. Na sve ovo postoji i opcija biciklističkog vodiča – iskusnog vozača. Rent a bike vodič Vas može povesti i u nezaboravno iskustvo na jedan ili više dana u Nacionalni park Fruška gora.</p>
    </div>
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Novi bicikl</a></li>
        </ul>
      </div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Iskustva <span>naših korisnika</span></h2>
    </div>
    <div class="row">
